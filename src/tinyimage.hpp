...
enum TinyImgError
{
    ...
    TINYIMG_FILE_EXISTS,
    TINYIMG_FILE_CAN_BE_CREATED
};

#define FILEFLAGS_READBINARY "rb"
#define FILEFLAGS_WRITEBINARY "wb"
...
///#ifdef __cplusplus
#ifdef __NeverDefinedAsThisPartIsNotImplemented

#define TINYIMG_BEGIN \
    namespace tinyimg \
    {
#define TINYIMG_END }
